const Hero = () => {
  return (
    <div
      id="hero"
      className="w-full min-h-screen md:min-h-[630px] bg-cover bg-center flex flex-col items-start md:items-center md:justify-center"
      style={{
      ...
      <div className="flex items-center flex-col w-full md:max-w-[75%] gap-10 md:gap-10 md:mt-0 mt-20 md:px-0 px-10 ">
        ...
        <div className="md:w-[500px] w-full md:h-20 text-center space-y-3">
          <p className="text-white md:text-[16px] w-full">
        ...
        <div className="flex gap-4 md:mt-4  ">
          <button className="px-6 py-2 bg-[#00BF63] text-white rounded-[5px] font-light md:text-[16px]">
            Discover More
          </button>
